...
class FrameStack(gym.Wrapper):
    ...
    def _get_ob(self):
        ...
        # returns in shape of (4, 84, 84) instead of (84, 84, 4)
        # self.k = channels
        # self.frames[0].shape[0], self.frames[0].shape[1] = height, width
...
"""
Image normalization : scales pixel values between 0 - 1
This undoes memory optimization, so only use for small replay buffers.
"""
